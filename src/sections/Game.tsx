...
const MemoryGame = dynamic(() => import('@/components/MemoryGame'), { 
  ssr: false,
  loading: () => <LoadingCard>Loading Memory Game...</LoadingCard>
});
const GithubContributions = dynamic(() => import('@/components/GithubContributions'), { 
  ssr: false,
  loading: () => <LoadingCard>Loading GitHub Data...</LoadingCard>
});
const ContactForm = dynamic(() => import('@/components/ContactForm'), { 
  ssr: false,
  loading: () => <LoadingCard>Loading Contact Form...</LoadingCard>
});
